              ...
              <AccordionItem border="none">
                ...
                <Flex mt={[4, 8]}>
                  ...
                  <Flex mt={[4, 8]}>
                    ...
                    <Text color="brand.darkGray" fontWeight="bold" ml={[1]}  whiteSpace="nowrap" overflow="hidden">
                      <Link display="block" whiteSpace="nowrap" overflow="hidden" textOverflow="ellipsis" href={`https://tzkt.io/${contractAddress}`}>{!!state.selectedCollection ? `${state.collections[state.selectedCollection]?.metadata.name} - ${contractAddress}` : `${contractAddress}`}&nbsp;<sup><img src={lk} alt="" width="auto" height="auto" style={{display: 'inline-block'}} /></sup></Link>
                    </Text>
                  </Flex>
